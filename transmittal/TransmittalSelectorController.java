 ...
 * @author Steven
 */
public class TransmittalSelectorController extends AbstractController implements Initializable {
    ...
    public void additem(ActionEvent event) throws SQLException {
        ...
        this.item = iq.getInventory(this.inventorytable.getSelectionModel().getSelectedItem().getIdinventory(), 1);
    ...
    private void searchSKU(String sku) throws SQLException{
        ...
        if(this.descbtn.isSelected()){
            rs = iq.getInventoriesByWHDesc(sku, "BC", 1);
        }else{
            rs = iq.getInventoriesByWH(sku, "BC", 1);
        }
