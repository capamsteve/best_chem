 ...
 * @author Steven
 */
public class STItemsController extends AbstractController implements Initializable {
    ...
    private InventoryModel parallel_item;
    ...
    public void saveItem(ActionEvent event) throws SQLException {
        ...
        InventoryModel im = this.inventorytable.getSelectionModel().getSelectedItem();
        
        item = iq.getInventory(this.inventorytable.getSelectionModel().getSelectedItem().getIdinventory(), super.getType());
        item.setSoh(this.getQty());
        
        System.out.println(item.getSku() + " " + item.getUom() + " " + item.getWh());
        
        parallel_item = iq.getInventory(item.getSku(), "PC", "SG", super.getType());
        
        System.out.println(parallel_item.getSku() + " " + parallel_item.getUom() + " " + parallel_item.getWh());
    ...
    /**
     * @return the parallel_item
     */
    public InventoryModel getParallel_item() {
        return parallel_item;
    }
