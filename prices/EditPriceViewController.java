 ...
 * @author Steven
 */
public class EditPriceViewController extends AbstractController implements Initializable {
    ...
    void savePrice(ActionEvent event) throws SQLException {
        ...
        pmod.setSellingprice(Double.valueOf(this.sellfld.getText()));
    ...
    public void setPrice(PricesModel price){
        ...
        this.sellfld.setText(String.valueOf(price.getSellingprice()));
